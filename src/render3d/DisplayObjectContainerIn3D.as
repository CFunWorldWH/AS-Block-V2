 ...
 */
public class DisplayObjectContainerIn3D extends Sprite implements IRenderIn3D {/*SCRATCH::allow3d_wh*/{
	...
	//import flash.utils.getQualifiedClassName;//不加的话下面报错未定义_wh
...
internal final class Dbg {
	public static function printObj(obj:*):String {
		...
		return null;//flash.utils.getQualifiedClassName(obj) + memoryHash;//报错，flash未定义，删除_wh
	}
}
